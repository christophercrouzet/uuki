...
RX_TEST_CASE(tokenizer, scan_valid_number_literals)
{
    ...
    TEST_TOKEN_SCANNING(
        "1",         
        W_TOKEN_ID_LITERAL_INT_DECIMAL,
        NULL
    );
    TEST_TOKEN_SCANNING(
        "0",         
    ...
    TEST_TOKEN_SCANNING(
        "0x1",             
        W_TOKEN_ID_LITERAL_INT_HEXADECIMAL,
        NULL
    );
    TEST_TOKEN_SCANNING(
        "0x0",             
    ...
    TEST_TOKEN_SCANNING(
        "0.",     
        W_TOKEN_ID_LITERAL_FLT_DECIMAL,
        NULL
    );
    TEST_TOKEN_SCANNING(
        ".0",     
    ...
    TEST_TOKEN_SCANNING(
        "0x0p0",       
        W_TOKEN_ID_LITERAL_FLT_HEXADECIMAL,
        NULL
    );
    TEST_TOKEN_SCANNING(
        "0x123EFp-345",
...
RX_TEST_CASE(tokenizer, scan_invalid_number_literals)
{
    ...
    TEST_TOKEN_SCANNING(
        "1.23e",
        W_TOKEN_ID_INVALID,
        "unterminated floating exponent"
    );
    TEST_TOKEN_SCANNING(
        "1.23e+",
        W_TOKEN_ID_INVALID,
