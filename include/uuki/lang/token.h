...
#define WP_TOKEN_ID_ENUM(x)                                                    \
    ...
    x(W_TOKEN_ID, EOF),                                                        \
    x(W_TOKEN_ID, LITERAL_FLT_DECIMAL),                                        \
    x(W_TOKEN_ID, LITERAL_FLT_HEXADECIMAL),                                    \
    x(W_TOKEN_ID, LITERAL_INT_BINARY),                                         \
    x(W_TOKEN_ID, LITERAL_INT_DECIMAL),                                        \
    x(W_TOKEN_ID, LITERAL_INT_HEXADECIMAL),                                    \
    x(W_TOKEN_ID, LITERAL_INT_OCTAL),                                          \
